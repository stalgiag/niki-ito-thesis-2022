class Chapter2 {
    constructor() {
        ...
        // let slide10texts = new Txt(slide10namePlate, slide10convoJ, slide10convoE);
        ...
        // let slide13texts = new Txt(slide13namePlate, slide13convoJ, slide13convoE);
        ...
        //     "...",
        //     "(What's wrong Sora?)"];
        // let slide14texts = new Txt(slide14namePlate, slide14convoJ, slide14convoE);
        ...
        // let slide15texts = new Txt(slide15namePlate, slide15convoJ, slide15convoE);
        ...
        // let slide17texts = new Txt(null, slide17convoJ, slide17convoE);
        ...
        // let slide20texts = new Txt(null, slide20convoJ, slide20convoE);
        ...
        this.slides.push(new Slide(slide3scene, nextSlideButton, null, null, null )); //3
        this.slides.push(new Slide(slide4scene, nextSlideButton, null, null, null )); //4
        this.slides.push(new Slide(slide5scene, nextSlideButton, null, null, null )); //5
        this.slides.push(new Slide(slide6scene, nextSlideButton, null, null, null )); //6
        this.slides.push(new Slide(slide7scene, nextSlideButton, null, null, null )); //7
        this.slides.push(new Slide(slide8scene, nextSlideButton, null, null, null )); //8
        this.slides.push(new Slide(slide9scene, nextSlideButton, slide9Choices, null, null )); //9
        this.slides.push(new Slide(slide10scene, nextSlideButton, null, null, null )); //10
        this.slides.push(new Slide(slide11scene, nextSlideButton, null, null, null )); //11
